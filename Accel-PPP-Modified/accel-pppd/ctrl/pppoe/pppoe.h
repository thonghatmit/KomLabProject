...
// FRIDOLIN: moved here from pppoe.c
#ifdef RADIUS
#include "radius.h"
#endif
#include "ppp.h"
...
struct pppoe_conn_t *allocate_channel_migrated(struct pppoe_serv_t *serv, const uint8_t *addr, const uint8_t *cookie, uint16_t migrated_sid);
